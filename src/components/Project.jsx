...
function Project({onCardClick, project, id, src, title, site, git, fade}) {
    ...
    return(
      <li className={fade ? `portfolio__item portfolio__item_fade-in` : `portfolio__item portfolio__item_fade`} key={id} onClick={handleClick}>
        <img className="portfolio__img" src={src} alt={title}></img>
        <div className="portfolio__links">
          <h5 className="portfolio__header_5">{title}</h5>
